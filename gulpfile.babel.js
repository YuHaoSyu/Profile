...
let p5JS = './node_modules/p5/lib/p5.min.js'
...
export const vendors = cb => {
  g.src([...bower(), p5JS]) //, b4Path + b4JSmain-bower-files:抓取套件主檔案
...
exports.build = g.series(clean, imageMin, vendors, babel, sass, pug)
